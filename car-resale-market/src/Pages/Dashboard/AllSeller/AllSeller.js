...
const AllSeller = () => {
    const {data: allusers = [], refetch } =useQuery({
        queryKey:['allusers'],
        queryFn: async() =>{
            const res = await fetch('https://car-resale-market-server-site-selimalahi.vercel.app/allusers?role=seller');
    ...
    const handleDeleteseller = user =>{
      fetch(`https://car-resale-market-server-site-selimalahi.vercel.app/seller/${user._id}`, {
              method: 'DELETE', 
              headers: {
