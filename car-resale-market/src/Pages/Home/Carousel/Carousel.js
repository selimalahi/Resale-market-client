  ...
  return (
    <div className="carousel w-full mt-10 rounded-lg">
      <div id="slide1" className={`carousel-item relative w-full ${activeSlide === 1 ? 'active' : ''}`}>
        <img src={banner1} className="w-full h-auto" alt="" />
        <div className="absolute flex justify-between transform -translate-y-1/2 left-8 md:left-24 top-1/3">
      ...
      <div id="slide2" className={`carousel-item relative w-full ${activeSlide === 2 ? 'active' : ''}`}>
        <img src={banner2} className="w-full h-auto" alt="" />
        <div className="absolute flex justify-between transform -translate-y-1/2 left-8 md:left-24 top-1/3">
          <h1 className="text-3xl md:text-5xl font-bold text-orange-400">
            Used Car For Sale <br />
            FIND YOURS!
      ...
      <div id="slide3" className={`carousel-item relative w-full ${activeSlide === 3 ? 'active' : ''}`}>
        <img src={banner3} className="w-full h-auto" alt="" />
        <div className="absolute flex justify-between transform -translate-y-1/2 right-8 md:right-28 top-1/3">
          <h1 className="text-3xl md:text-5xl font-bold text-orange-400">
            Affordable
          </h1>
        </div>
        <div className="absolute flex justify-between transform -translate-y-1/2 right-8 md:right-44 top-1/2">
